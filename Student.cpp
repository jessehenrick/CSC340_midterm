...
//helper functions for complex algos
...
void Student::getProbabilityOfSchoolAndGender(double size, vector<string> setvectsex,vector<string> setvect2){
    ...
    if(choiceA == 'M' && choiceB == "GP"){
        ...
        cout <<"The probability of a student drinker being male and going to Gabriel Pereira is: " << newProbability << "%.\n\nReturning to Menu..." << endl;
    }
...
void Student::MakeProfile(double size, vector<double> sett, vector<string> setvectsex,vector<string> setvectschool, vector<string>vecthome) {
    ...
    cout << "Please enter [H] to create a profile for a student with most determining drinking factors,\nor [L] for least determining factors\nWrite down your option here:";
    char choiceA;
    cin >> choiceA;
    ...
    string profile = "\nStudent profile most likely to drink contains the following determining factors: ";
    //compare each probability to find lowest and highest of each category
    //comparisons for if the user wants to see the traits with the highest probability for each data point
    if(choiceA == 'H') {
        ...
        //comparisons for if the user wants to see the traits with the lowest probability for each data point
    else if(choiceA == 'L') {
        profile = "\nStudent profile least likely to drink contains the following determining factors: ";
        if(probOfGP < probOfMS) {
            profile = profile + "\nSchool: Gabriel Pereira";
        } else {
            profile = profile + "\nSchool: Mousinho da Silveira";
